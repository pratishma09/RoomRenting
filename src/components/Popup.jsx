  ...
  return (
    <div className="fixed inset-0 bg-opacity-50 backdrop-blur-sm flex flex-row justify-center items-center room-details">
      <div className="text-blue-400 bg-white min-w-0 max-w-80 px-10  rounded-lg">
        <button className="font-semibold my-10" onClick={() => onClose}>
          X{" "}
        </button>
        <p className="text-2xl font-semibold pb-5">ABOUT THE ROOM</p>
        <img src={rooms.photos} className="w-[450px] pb-10" />
      </div>
      <div className="min-w-0 max-w-80 px-10 py-8 bg-white rounded-lg text-start">
        ...
        <p className="text-gray-300 font-extralight">{rooms.description}</p>
        <div className="flex justify-between">
